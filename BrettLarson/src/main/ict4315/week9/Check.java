 ...
 * 
 */
public class Check implements Printable, Serializable {
	 ...
	 * @param amount
	 */
	public Check(String accountId, String bankId, String payee, String date, int checkNumber, double amount, Printer printer) {
