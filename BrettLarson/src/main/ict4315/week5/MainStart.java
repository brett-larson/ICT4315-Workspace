...
public class MainStart {
	 ...
	 * @throws IOException 
	 */
	public static void buildCheckObject() throws IOException {
		//This method is called when an application user chooses to build a User
		...
		//Code to prompt and store user response to print or not print a check
		System.out.println("The check object was created successfully.");
		System.out.println("Would you like to print your check?");
		System.out.println("Enter 1 for Yes and 2 for No: ");
		userIntInput = input.nextInt();
		

		//Logic to read the user input to create or not create a file
		if(userIntInput == 1 ) {
			System.out.println("A new file will be created if one does not already exist.");
			check.printMethod();
		} else if (userIntInput == 2) {
			System.out.println("You have chosen to not print a new check.");
		} else {
